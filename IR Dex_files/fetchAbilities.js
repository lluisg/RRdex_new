async function getAbilities(abilities){
    ...
    const rawAbilities = await fetch(`https://raw.githubusercontent.com/${repo1}/data/abilities/abilities.h`)
...
async function getVanillaAbilitiesDescription(abilities){
    const rawVanillaAbilitiesDescription = await fetch(`https://raw.githubusercontent.com/${repo1}/data/abilities/ability_descriptions.string`)
...
async function getAbilitiesIngameName(abilities){
    ...
    const rawAbilitiesIngameName = await fetch(`https://raw.githubusercontent.com/${repo1}/data/abilities/ability_name_table.string`)
...
async function getAbilitiesDescription(abilities){
    ...
    const rawAbilitiesDescription = await fetch(`https://raw.githubusercontent.com/${repo1}/data/abilities/ability_descriptions.string`)
...
async function getNewAbilities(abilities){
    const rawNewAbilities = await fetch(`https://raw.githubusercontent.com/${repo1}/data/abilities/duplicate_abilities.h`)
